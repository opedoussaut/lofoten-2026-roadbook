...
// Prices, rental conditions and links checked for the 2026 trip on 12 Aug 2026.
  ...
  app.innerHTML = `
    ...
    <div class="grid" style="margin-top:12px">
      <section class="card">
        ...
        <div style="padding:12px;border-radius:10px;background:rgba(35,140,80,.12);margin-top:10px">
          <strong>Budget du combo : 3 050 NOK pour 2.</strong><br>
          <span class="muted">Une sortie libre et économique dans l'archipel protégé de Ballstad + une sortie iconique à Reine avec un guide local.</span>
        </div>
      ...
      <section class="card">
        ...
        <p><strong>Oui, mais pas simplement sur la base de l'expérience déclarée.</strong> Les deux loueurs autonomes vérifiés demandent une qualification reconnue de kayak de mer.</p>
        ...
        <p class="muted">Sans certification reconnue : prévoir une sortie guidée. Ne compter sur aucune location autonome avant confirmation du loueur.</p>
      </section>
    </div>
    ...
    <div class="grid" style="margin-top:12px">
      <section class="card">
        ...
        <p><strong>Pas de certification reconnue :</strong><br>Reinefjord guidé ; Ballstad guidé si on veut une deuxième session.</p>
        <p><strong>Météo moyenne mais envie de pagayer :</strong><br>Svolvær ou Henningsvær avec guide.</p>
        <p><strong>Vent / houle côté océan :</strong><br>ne pas choisir Unstad / Uttakleiv ; changer de côte ou d'activité.</p>
      </section>
      ...
      <section class="card">
        ...
        <p class="muted">Tarifs indicatifs publiés et vérifiés le 12/08/2026 ; disponibilité et prix restent à recontrôler avant réservation.</p>
      </section>
    </div>
    ...
    <section class="card" style="margin-top:12px">
      ...
      <p class="muted">Sources : Visit Lofoten, Lofoten Diving, Lofoten Aktiv, Saga Adventures, Reine Rorbuer, XXLofoten et Reine Paddling. Vérifié le 12 août 2026.</p>
    </section>`;
}
